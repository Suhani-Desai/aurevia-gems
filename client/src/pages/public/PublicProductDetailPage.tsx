...
export function PublicProductDetailPage() {
  ...
  if (loading) {
    return (
      <div className="mx-auto max-w-[1440px] px-5 py-24 text-sm text-[var(--muted)] md:px-10">
        Loading product...
      </div>
    );
  }
    ...
    <section className="border-b border-[var(--border)]">
      <div className="mx-auto grid max-w-[1440px] gap-10 px-5 py-12 md:grid-cols-2 md:gap-16 md:px-10 md:py-20">
        ...
        <div className="flex flex-col justify-center">
          ...
          <dl className="mt-10 space-y-4 border-y border-[var(--border)] py-6 text-sm">
            <div className="flex justify-between gap-6">
              <dt className="text-[var(--muted)]">SKU</dt>
              <dd>{product.sku}</dd>
            </div>
            <div className="flex justify-between gap-6">
              <dt className="text-[var(--muted)]">Business pricing</dt>
